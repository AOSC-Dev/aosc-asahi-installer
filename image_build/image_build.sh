...
BASE_IMAGE_URL="https://mirrors.bfsu.edu.cn/anthon/aosc-os/os-arm64/base/aosc-os_base_20220508_arm64.tar.xz"
...
make_image() {
    ...
    wget -O "$img/esp/m1n1/boot.bin" https://repo.aosc.io/misc/boot.bin
    echo "### Compressing..."
    rm -f "$img".zip
